...
simulation_run_new(void)
{
  ...
  new_simulation_run = (Simulation_Run_Ptr) xmalloc(sizeof(Simulation_Run));	// allocate space
  new_simulation_run->eventlist = eventlist_new();	// initialize new event list
  new_simulation_run->clock = clock_new();			// initialize new clock
  new_simulation_run->data = NULL;					// initialize data
